...
#### SimpleNft
Create a basic Nft collection to understand how it works, ...
#### RebaseToken
Creation of a rebase token, crosschain (did not do the crosschain content)
#### MerkleAirdrop
...
Cheatsheet of openZeppelin most used util. ERC20, ERC20Pausable, SafeERC20, ERC721, ReentrancyGuard, AccessControl, Ownable,
